...
public class MethodStmtSwitch implements StmtSwitch
{
    ...
    public void popMonitor(){ m_oldValueFromMonitorStack.pop(); }
    ...
    public void caseAssignStmt(AssignStmt arg0) { caseDefinitionStmt(arg0); }

    public void caseIdentityStmt(IdentityStmt arg0) { caseDefinitionStmt(arg0); }
    ...
    @Override public String toString(){ return m_output.toString(); }
    void setTrapItems(List<TrapItem> trap_items) { m_trapItems = trap_items; }
    void reset() { m_valueSwitch.reset(); }
    boolean hasCaughtExceptionRef(){ return m_valueSwitch.hasCaughtExceptionRef(); }
    public String getThisRef() { return m_valueSwitch.getThisRef(); }
