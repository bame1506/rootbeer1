...
public class OpenCLMethod
{
    ...
    public String getArgumentListStringPolymorphic(){ return getArgumentListStringInternal(true);
    }
    ...
    private String writeInstanceInvoke
    (
        final InstanceInvokeExpr arg0,
    ...
    @Override public String toString(){ return getPolymorphicName(); }
    ...
    public boolean isSynchronized() { return m_sootMethod.isSynchronized(); }
    ...
    public SootMethod getSootMethod() { return m_sootMethod; }
}
