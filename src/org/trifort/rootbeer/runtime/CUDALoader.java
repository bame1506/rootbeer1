...
public class CUDALoader
{
     ...
     **/
    private void doLoad( final List<String> paths )
    {
    ...
    private void extract( final String filename )
    {
        ...
        try
        {
            /* first try absolute path, then relative */
            ...
            final OutputStream os = new FileOutputStream(RootbeerPaths.v().getRootbeerHome()+filename);
            while ( true )
            {
