...
public class GpuDevice
{
    ...
    )
    {
        ...
        ret.setClockRateHz                ( clock_rate*1000);  // clock_rate as returned by cuDeviceGetAttribute is in kHz
        ret.setMemoryClockRateHz          ( memory_clock_rate*1000); // same as clock_rate
    ...
    public int getPeakFlops()
    {
        return m_multiProcessorCount * getCudaCoresPerMultiprocessor() * m_clockRateHz;
    }
    ...
    public int     getClockRateHz                (){ return m_clockRateHz ; }
    ...
    public int     getMemoryClockRateHz          (){ return m_memoryClockRateHz          ; }
    ...
    public void    setDeviceId                   (int device_id){ m_deviceId     = device_id; }
    public void    setDeviceName                 (String name)  { m_name         = name     ; }
    public void    setWarpSize                   (int value)    { m_warpSize     = value    ; }
    public void    setMaxPitch                   (int value)    { m_maxPitch     = value    ; }
    public void    setClockRateHz                (int value)    { m_clockRateHz  = value    ; }
    public void    setIntegrated                 (boolean value){ m_integrated   = value    ; }
    ...
    public void    setMemoryClockRateHz          (int value)    { m_memoryClockRateHz           = value; }
