...
public class RootbeerTestAgent
{
    ...
    private final List<String> m_failedTests;
    ...
    public void testOne( final ClassLoader cls_loader, final String test_case ) throws Exception
    {
    ...
    ) throws Exception
    {
        ...
        for ( final TestSerialization creator : creators )
        {
        ...
        for ( final TestException ex_creator : ex_creators )
        {
        ...
        for ( final TestSerialization creator : change_thread )
        {
            System.out.println("[TEST "+test_num+"/"+num_tests+"] "+creator.toString());
    ...
    private final class ChangeThread implements Runnable
    {
